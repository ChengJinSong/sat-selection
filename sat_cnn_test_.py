...
PARA = {'batch_size': 128, 'num_of_solvers': 31, 'num_of_eval_data': 129}
THRESHOLD = [0.5]
DATASET = 'D:/SAT-instance/SAT12-indu-data'
LOGFILE = 'D:/SAT-instance/log/SAT12-indu_test.txt'
...
def cnn_model(features, labels, mode, params):
    ...
    #     save_steps=10,
    #     output_dir='D:/training_model/sat_summary/',
...
def main():
    ...
    sat_clf = tf.estimator.Estimator(
        model_fn=cnn_model,
        model_dir='D:/training_model/sat12_indu_cnn_test',
        params=PARA)

    # Set up logging for predictions
    # steps = tf.train.get_global_step()
    # tensors_to_log = {"steps": steps, "loss": }
    ...
    while epoch <= 101:
        ...
        train_input_fn = tf.estimator.inputs.numpy_input_fn(
            ...
            num_epochs=10,
            shuffle=True)
        sat_clf.train(input_fn=train_input_fn)
