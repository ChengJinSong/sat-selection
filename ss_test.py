...
with ops.Graph().as_default() as g:
    ...
    with g.device("/device:GPU:0"):
        ...
        #     writer = tf.summary.FileWriter("C:/Users/MN/Desktop/td")
        ...
        #             writer.add_summary(sm, gs)
        #         if e == 9 and b == 8:
        #             saver.save(ss, save_path="C:/Users/MN/Desktop/td/model.ckpt", global_step=gs)
